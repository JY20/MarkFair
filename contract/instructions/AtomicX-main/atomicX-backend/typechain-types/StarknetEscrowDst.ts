...
export interface StarknetEscrowDstInterface extends utils.Interface {
  functions: {
...
export interface StarknetEscrowDst extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StarknetEscrowDstInterface;
